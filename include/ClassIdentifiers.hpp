...
enum struct ClassIdentifier
{
  ...
  CLASS_ID_TABLE = 121,
  CLASS_ID_CONFIGURABLE_FEATURE = 122,
...
constexpr auto CCLASS_ID_KING_DECORATIVE_STATUE = 102;
constexpr auto CCLASS_ID_QUEEN_DECORATIVE_STATUE = 103;
constexpr auto CCLASS_ID_WARLORD_DECORATIVE_STATUE = 104;
constexpr auto CCLASS_ID_KNIGHT_DECORATIVE_STATUE = 105;
constexpr auto CCLASS_ID_HIGH_PRIEST_DECORATIVE_STATUE = 106;
constexpr auto CCLASS_ID_SORCEROR_DECORATIVE_STATUE = 107;
constexpr auto CCLASS_ID_FIRE_PILLAR = 115;
constexpr auto CCLASS_ID_FOUNTAIN = 116;
constexpr auto CCLASS_ID_FORGE = 279;
constexpr auto CCLASS_ID_TANNERY = 280;
