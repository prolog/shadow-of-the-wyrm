...
enum ClassIdentifier
{
  ...
  CLASS_ID_ETHER_EFFECT,
  CLASS_ID_FRUIT_JUICE_EFFECT,
  CLASS_ID_HEALING_EFFECT,
  CLASS_ID_IDENTIFY_EFFECT,
  CLASS_ID_NULL_EFFECT,
  CLASS_ID_WEIGHT,
  CLASS_ID_AMMUNITION,
  CLASS_ID_AMULET,
  CLASS_ID_ARMOUR,
  ...
  CLASS_ID_INVENTORY,
  CLASS_ID_EQUIPMENT,
  CLASS_ID_SWEET_TASTE_EFFECT_MESSAGE,
  CLASS_ID_METADATA
};
