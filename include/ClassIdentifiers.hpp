...
enum struct ClassIdentifier
{
  ...
  CLASS_ID_SCREEN_KEYBOARD_COMMAND_MAP,
  CLASS_ID_HELP_KEYBOARD_COMMAND_MAP,
  CLASS_ID_SKILLS_KEYBOARD_COMMAND_MAP,
  CLASS_ID_ACTION_MANAGER,
  CLASS_ID_TILE_SELECTION_ACTION,
  CLASS_ID_WORLD,
  CLASS_ID_CALENDAR,
  CLASS_ID_SPRING,
  CLASS_ID_SUMMER,
  ...
  CLASS_ID_WORLD_TIME_OBSERVER,
  CLASS_ID_SEASONS_TIME_OBSERVER,
  CLASS_ID_SPECIAL_DAY_OBSERVER,
  CLASS_ID_AGE_TIME_OBSERVER,
  CLASS_ID_MAP_TIME_OBSERVER,
  ...
  CLASS_ID_WILD_ORCHARD_TILE,
  CLASS_ID_FRUIT_TREE_TILE,
  CLASS_ID_EVERGREEN_TREE_TILE,
  CLASS_ID_ROCKY_EARTH_TILE,
  CLASS_ID_WELL_TILE,
  CLASS_ID_CRYPT_TILE,
  CLASS_ID_AIR_TILE,
  CLASS_ID_EARTH_TILE,
  CLASS_ID_SEWER_COMPLEX_TILE,
  CLASS_ID_SEWER_TILE,
  CLASS_ID_SHRINE_TILE,
  CLASS_ID_SEABED_TILE,
  ...
  CLASS_ID_LOCK,
  CLASS_ID_TRAP,
  CLASS_ID_SARCOPHAGUS,
  CLASS_ID_TABLE,
  CLASS_ID_BASIC_FEATURE,
  CLASS_ID_SLOT_MACHINE,
  CLASS_ID_PLAYER_DECISION_STRATEGY,
  CLASS_ID_AUTOMATIC_MOVEMENT_DECISION_STRATEGY,
  ...
  CLASS_ID_QUESTS,
  CLASS_ID_QUEST,
  CLASS_ID_LOADED_MAP_DETAILS,
  CLASS_ID_SPELL_KNOWLEDGE,
  CLASS_ID_INDIVIDUAL_SPELL_KNOWLEDGE,
  CLASS_ID_MAGIC_COMMAND_FACTORY,
  CLASS_ID_SCREEN_COMMAND_FACTORY,
  CLASS_ID_HELP_COMMAND_FACTORY,
  CLASS_ID_SKILLS_COMMAND_FACTORY,
  CLASS_ID_MAGIC_KEYBOARD_COMMAND_MAP,
  CLASS_ID_REGULAR_STATUE,
  CLASS_ID_PETRIFIED_CORPSE_STATUE,
  CLASS_ID_SCRIPT_ENGINE,
  CLASS_ID_AUTOMATIC_MOVEMENT,
  CLASS_ID_STATUS_AILMENTS,
  CLASS_ID_BARREL,
  CLASS_ID_BLOOD,
  CLASS_ID_CONDUCTS,
  CLASS_ID_SCORE_FILE_ENTRY,
  CLASS_ID_SETTINGS,
  CLASS_ID_MESSAGE_BUFFER,
  CLASS_ID_DEITY,
  CLASS_ID_CREATURE_ACTIONS,
  CLASS_ID_MODIFIER,
  CLASS_ID_ALIGNMENT,
  CLASS_ID_FORGE,
  CLASS_ID_TANNERY,
  CLASS_ID_JEWELER_WORKBENCH,
  CLASS_ID_WHEEL_AND_LOOM,
  CLASS_ID_BED,
  CLASS_ID_STONE_MARKER,
  CLASS_ID_INITIAL_ITEM,
  CLASS_ID_SCRIPT_DETAILS,
  CLASS_ID_DIG_CHANCES,
  CLASS_ID_TILE_TRANSFORM,
  CLASS_ID_TILE_TRANSFORM_OBSERVER,
  CLASS_ID_CALENDAR_DAY,
  CLASS_ID_MARKS,
  CLASS_ID_SHOP,
