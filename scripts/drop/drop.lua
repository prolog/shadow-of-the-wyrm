...
-- run the script.
function drop(dropping_creature_id, fov_creature_id, fov_creature_base_id, item_base_id, drop_y, drop_x)
  local drop_fn = drop_fns[fov_creature_base_id]

  if drop_fn ~= nil then
    drop_fn(dropping_creature_id, fov_creature_id, item_base_id, drop_y, drop_x)
  end
end
