...
world_shrine:set_additional_properties({["MAP_PROPERTIES_RELIC_ID"] = "heart_world", ["MAP_PROPERTIES_CREATURE_IDS"] = "dragon,war_mammoth,skywing,golgothan,wyrm,titan", ["MAP_PROPERTIES_IGNORE_CREATURE_LVL_CHECKS"] = "1"})
