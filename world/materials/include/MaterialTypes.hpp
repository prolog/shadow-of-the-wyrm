...
enum struct MaterialType
{
  ...
  MATERIAL_TYPE_GASES = 14,
  MATERIAL_TYPE_UNKNOWN = 15,
  MATERIAL_TYPE_MEAT = 16,
  MATERIAL_TYPE_CLAY = 17,
  MATERIAL_TYPE_PLANT = 18,
  MATERIAL_TYPE_WATER = 19,
  MATERIAL_TYPE_LAST = 20
};
