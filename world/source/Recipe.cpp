...
Recipe::Recipe(const Ingredients& new_ingredients, const uint new_skill_required, const string& new_item_id)
: ingredients(new_ingredients), skill_required(new_skill_required), item_id(new_item_id)
{
}
