...
TEST(SW_World_Damage, contains_dam_type)
{
  ...
  std::shared_ptr<Damage> addl_damage1(new Damage(1, 2, 3, DamageType::DAMAGE_TYPE_PIERCE, {}, false, false, false, false, false, false, false, false, 0, sa));
  std::shared_ptr<Damage> addl_damage2(new Damage(1, 2, 3, DamageType::DAMAGE_TYPE_HOLY, {}, false, false, false, false, false, false, false, false, 0, sa));
  std::shared_ptr<Damage> addl_damage3(new Damage(1, 2, 3, DamageType::DAMAGE_TYPE_ACID, {}, false, false, false, false, false, false, false, false, 0, sa));
