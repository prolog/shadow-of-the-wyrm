...
TEST(SW_World_Alignment, abrv_sid)
{
  ...
  EXPECT_EQ(TextKeys::ALIGNMENT_EVIL_ABRV, a.get_abbreviation_sid(AlignmentRange::ALIGNMENT_RANGE_EVIL));
  EXPECT_EQ(TextKeys::ALIGNMENT_GOOD_ABRV, a.get_abbreviation_sid(AlignmentRange::ALIGNMENT_RANGE_GOOD));
...
TEST(SW_World_Alignment, align_sid)
{
  ...
  EXPECT_EQ(TextKeys::ALIGNMENT_EVIL, a.get_alignment_sid(AlignmentRange::ALIGNMENT_RANGE_EVIL));
  EXPECT_EQ(TextKeys::ALIGNMENT_GOOD, a.get_alignment_sid(AlignmentRange::ALIGNMENT_RANGE_GOOD));
...
TEST(SW_World_Alignment, default_for_range)
{
  ...
  EXPECT_EQ(0, a.get_default_alignment_for_range(AlignmentRange::ALIGNMENT_RANGE_NEUTRAL));
  EXPECT_EQ(-1600, a.get_default_alignment_for_range(AlignmentRange::ALIGNMENT_RANGE_EVIL));
...
TEST(SW_World_Alignment, alignment_ranges)
{
  ...
  EXPECT_EQ(AlignmentRange::ALIGNMENT_RANGE_EVIL, a.get_alignment_range());
  ...
  EXPECT_EQ(AlignmentRange::ALIGNMENT_RANGE_NEUTRAL, a.get_alignment_range());
