...
SkillsCommandKeys::SkillsCommandKeys()
{
}
...
const string SkillsCommandKeys::GENERAL_SKILLS = "GENERAL_SKILLS";
const string SkillsCommandKeys::MELEE_WEAPON_SKILLS = "MELEE_WEAPON_SKILLS";
