...
void KeyboardCommandMap::command_not_found(const string& keyboard_input)
{
  ...
  string keyboard_input_as_character = string(1, String::to_int(keyboard_input));
...
vector<string> KeyboardCommandMap::get_remappable_commands() const
{
  ...
  CommandKeys::FIRE_MISSILE, CommandKeys::QUAFF, CommandKeys::READ, CommandKeys::CHECK_CURRENCY,
