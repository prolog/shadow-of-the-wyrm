...
const string CommandKeys::GAME_DATE_TIME_WEATHER = "GAME_DATE_TIME_WEATHER";
...
const string CommandKeys::RELOAD_SCRIPTS_ASSETS_AND_SIDS = "RELOAD_SCRIPTS_ASSETS_AND_SIDS";
