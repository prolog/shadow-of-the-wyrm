...
{
  {
    ...
    { 2, {"a", "e", "i", "o", "u"}},
    { 3, {"ab", "ad", "ag", "an", "ar", "at", "ax", "bad", "bal", "ban", "dal", "del", "el", "en", "fal", "fen", "ful", "rad", "rag", "ramn", "ran", "rin", "rumn", "run", "sen", "sin", "tan", "tat", "ten", "tet", "van", "vin", "vix", "yan", "yar" }}
  }
};
