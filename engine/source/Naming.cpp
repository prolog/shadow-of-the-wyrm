...
{
  {
    { 1, { "Ach", "Ad", "Adz", "Aed", "Ael", "Aer", "Al", "Ak", "Am", "Amn", "An", "Ann", "Ap", "Ar", "Ard", "Ast", "At", "Atn", "Au", "Ax", "Az", "Bac", "Bak", "Bal", "Bek", "Ban", "Bel", "Cad", "Ced", "Cam", "Cael", "Caer", "Dam", "Dan", "Dar", "Den", "Dip", "El", "Ex", "Ey", "Eye", "Eyx", "Fan", "Far", "Gael", "Gan", "Gel", "Gil", "Gon", "Had", "Hal", "Han", "Har", "Hear", "Hu", "Hur", "Ix", "Ip", "Kal", "Kan", "Kat", "Ket", "Kit", "Ox", "Pad", "Pan", "Ran", "Tam", "Tan", "Tar", "Tet", "Sar", "Scar", "Sel", "Sen", "Skar", "Star", "Ux", "Van", "Var", "Ven", "Vid", "Vir", "Yad", "Yan", "Yar", "Yd", "Ytt", "Zo", "Zu", "Zy"}},
    { 2, { "a", "e", "i", "o", "u"}},
    { 3, { "bad", "bae", "bakh", "bal", "bag", "ban", "bar", "bat", "bax", "beck", "bek", "bel", "bil", "cach", "cal", "can", "car", "crae", "dae", "dan", "den", "dex", "dil", "dix", "dor", "el", "fil", "gal", "gan", "gap", "gel", "gen", "gil", "gon", "ham", "han", "hel", "hem", "hen", "kha", "kam", "kan", "kar", "lan", "lin", "mar", "mi", "na", "nae", "nar", "ni", "ram", "ran", "tae", "tam", "tan", "tap", "tax", "tem", "wan", "well", "wen", "win", "ya", "yar", "ye", "yil", "za", "zar", "ze"}}
  }
};
