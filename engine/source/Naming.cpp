...
{
  { CreatureSex::CREATURE_SEX_MALE,   { { 1, { {1, { "Aesche", "Ahl", "Arc", "Amn", "Anm", "Arke", "Arkh", "Ashe", "Bal", "Bael", "Bane", "Barg", "Bash", "Bax", "Bek", "Bel", "Bhel", "Bink", "Birch", "Boh", "Bon", "Bonn", "Brae", "Bragg", "Brack", "Bren", "Brex", "Brick", "Bruck", "Cad", "Cade", "Cael", "Cain", "Cal", "Caln", "Calt", "Carr", "Cas", "Cid", "Cith", "Claye", "Clyne", "Creel", "Clyve", "Col", "Cole", "Colm", "Corr", "Crane", "Cram", "Crim", "Crom", "Cron", "Crow", "Crowe", "Cyd", "Dal", "Dalle", "Dane", "Dax", "Dun", "East", "Elm", "Eorl", "Erne", "Falk", "Fayne", "Finn", "Fil", "Flick", "Forde", "Froste", "Gael", "Gan", "Garr", "Ged", "Gend", "Gep", "Girn", "Guy", "Heath", "Helm", "Hep", "Holte", "Howa", "Howe", "Hume", "Hur", "Hylt", "Hymm", "Jak", "Jek", "Jax", "Jhair", "Jhain", "Jol", "Jot", "Kharne", "Karr", "Kay", "Kael", "Kel", "Kerr", "Knot", "Kronk", "Krul", "Kyp", "Layne", "Lev", "Llew", "Llyw", "Luh", "Lux", "Mace", "Marr", "Mak", "Mead", "Mill", "Mik", "Miles", "Mirk", "Myrr", "Nashe", "Nil", "Nodd", "North", "Null", "Nye", "Oak", "Orbe", "Pan", "Pat", "Pax", "Pearne", "Peart", "Pin", "Pine", "Pogg", "Pril", "Puck", "Quip", "Quinn", "Ran", "Rain", "Rex", "Rhode", "Rhun", "Rhon", "Rock", "Rogue", "Rom", "Rone", "Rushe", "Ryne", "Scrip", "Sel", "Serg", "Shaw", "Shere", "Sil", "Slade", "Slemp", "Sloan", "Stave", "Stone", "Stork", "Storm", "Tad", "Tal", "Tave", "Taye", "Tel", "Tep", "Tik", "Tir", "Tok", "Tooke", "Tor", "Trayne", "Trom", "Tull", "Tyg", "Varne", "Vayne", "Vel", "Vim", "Wart", "Wel", "Wink", "Wol", "Wulf", "Wyl", "Wyld", "Wyn", "Zane", "Zann", "Zog", "Zoq" } } } },
                                        { 2, { {1, { "A", "Ad", "Ae", "Ak", "Akh", "Ahl", "Al", "Am", "Amn", "An", "Ar", "Ark", "Arkh", "Ash", "Ax", "Az", "Ba", "Bad", "Bal", "Bael", "Bar", "Barg", "Bark", "Barn", "Bax", "Be", "Bel", "Ben", "Bi", "Bil", "Bo", "Boh", "Bon", "Bor", "Bra", "Bro", "Brae", "Brag", "Bram", "Bran", "Bren", "Bron", "Bru", "Brun", "Bu", "Bur", "Ca", "Cal", "Caed", "Cael", "Cap", "Cau", "Ce", "Ced", "Ci", "Cir", "Co", "Com", "Crae", "Cral", "Crel", "Da", "Dae", "Dag", "Dal", "Dam", "Dar", "De", "Dea", "Di", "Do", "Dor", "Dry", "Ea", "Eb", "Ec", "Ed", "Ek", "Em", "En", "Er", "Err", "Ey", "Ez", "Fa", "Fau", "Fei", "Feu", "Fi", "Fie", "Fo", "Fou", "Fu", "Fue", "Ga", "Gad", "Gae", "Gea", "Gra", "Grae", "Gre", "Gu", "Gul", "Gur", "Ha", "Hae", "Hak", "Hal", "Han", "Har", "Harm", "Haz", "He", "Hel", "Hem", "Hen", "Hep", "I", "Ix", "Ja", "Je", "Jel", "Jha", "Jhe", "Jhi", "Jhu", "Jo", "Ju", "Jul", "Ka", "Kal", "Kan", "Kap", "Kae", "Kael", "Kau", "Ke", "Kea", "Ko", "Kord", "Kra", "La", "Lae", "Le", "Lla", "Lle", "Lli", "Llo", "Llu", "Lly", "Lo", "Li", "Lu", "Ma", "Me", "Mu", "My", "Myr", "Myz", "Na", "Ne", "Nu", "O", "Oe", "Pa", "Pae", "Pal", "Phe", "Po", "Pol", "Pohl", "Pul", "Pra", "Pre", "Pri", "Qui", "Ra", "Rae", "Re", "Ru", "Sa", "Se", "Sel", "Su", "Sul", "Ta", "Tad", "Tal", "Tam", "Tan", "Tar", "Tau", "Te", "Tei", "Tel", "Teu", "Ti", "Tie", "Tik", "Til", "Tir", "Tor", "Tu", "Tyg", "U", "Va", "Vi", "Vy", "Wa", "Wau", "We", "Wi", "Wo", "Xa", "Xe", "Xen", "Ya", "Ye", "Za", "Zab", "Ze", "Zi", "Zo", "Zol", "Zon", "Zor", "Zu" } },
                                               {2, { "ab", "ac", "ad", "ael", "ag", "akh", "am", "an", "as", "at", "ath", "ax", "az", "ban", "bak", "bar", "bax", "baz", "bec", "beck", "bek", "bel", "ben", "berm", "bern", "bert", "bet", "beth", "bik", "cal", "cale", "cel", "ch", "dan", "dar", "de", "den", "du", "el", "es", "ex", "fan", "fax", "fae", "foe", "gan", "gen", "gew", "gon", "gonne", "gor", "gu", "gul", "iac", "ian", "ic", "im", "ix", "jax", "kal", "kam", "kan", "kel", "ken", "kh", "kin", "ko", "kul", "lac", "lal", "lan", "land", "las", "lale", "lel", "ling", "lon", "lec", "lic", "lone", "lul", "mak", "man", "mar", "max", "men", "mer", "mex", "min", "mon", "mor", "mux", "nak", "nel", "nex", "nul", "nuz", "od", "og", "on", "ox", "pa", "pan", "pas", "pen", "pet", "pul", "pol", "pog", "put", "rad", "ram", "ran", "rax", "red", "rex", "rix", "ro", "ron", "rul", "ryx", "san", "sak", "she", "sir", "sik", "sek", "some", "som", "son", "sz", "tag", "tar", "tal", "tek", "tel", "ten", "til", "tin", "ton", "tyn", "tul", "uc", "uck", "us", "ux", "val", "van", "var", "vax", "ver", "vex", "wad", "wam", "wan", "wel", "wen", "wick", "win", "wo", "wu", "wyk", "xad", "xar", "yak", "yen", "z", "zak", "zar", "zax", "zel", "zek", "zen", "zo", "zu", "zzo"
                                               } } } } } },
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Ashe", "Brig", "Bae", "Bea", "Belle", "Bie", "Bix", "Blue", "Bron", "Brie", "Bree", "Brea", "Bren", "Cass", "Cat", "Catte", "Cea", "Cel", "Cey", "Cil", "Crea", "Cresse", "Cwen", "Dove", "Elf", "Fae", "Fay", "Faye", "Fey", "Ferne", "Gaile", "Grace", "Gwen", "Hail", "Hil", "Hild", "Hilde", "Hope", "Hyld", "Ia", "Jade", "Jane", "Jass", "Jey", "Jil", "Joyce", "Joye", "Jy", "Kall", "Kat", "Joye", "Kai", "Kess", "Kell", "Kim", "Kish", "Lark", "Leah", "Lesse", "Lil", "Lish", "Liss", "Liv", "Lune", "Ly", "Lyn", "Mab", "Maeve", "Mer", "Mere", "Nan", "Nea", "Ness", "Nin", "Page", "Pea", "Pesh", "Pish", "Rae", "Rax", "Rey", "Ros", "Rhe", "Rhenne", "Rue", "Sage", "Saye", "Scout", "Sea", "Sel", "Shal", "Shae", "Shale", "Shan", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Sil", "Skye", "South", "Starre", "Swan", "Swaye", "Syd", "Syl", "Taff", "Tal", "Tash", "Tashe", "Teek", "Teel", "Tash", "Tass", "Taye", "Tesse", "Tish", "Vi", "West", "Winn", "Wysp", "Wenne", "Wrenne", "Wy", "Wynne", "Wyspe", "Yshe", "Yd", "Ym", "Zaye"} } } },
                                        { 2, { {1, { "Ac", "Ad", "Ae", "Ael", "Ai", "Al", "Am", "An", "Ap", "Ash", "Ba", "Be", "Bea", "Bhe", "Bi", "Ca", "Cae", "Ce", "Cea", "Cel", "Cen", "Cal", "Cha", "Chal", "Che", "Chel", "Cil", "Cre", "Da", "Dal", "Dry", "De", "Dea", "Del", "E", "Ea", "Ei", "Eil", "El", "Fa", "Fal", "Fay", "Fae", "Fe", "Fea", "Fen", "Fey", "Fi", "Fiy", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Is", "Iss", "Je", "Jeh", "Ji", "Ju", "Ka", "Kae", "Kah", "Kal", "Kam", "Ke", "Kel", "Kem", "Khu", "Ki", "Kie", "Key", "Ku", "La", "Li", "Lu", "Ly", "Ma", "Mah", "Mar", "Mae", "Me", "Mer", "Mea", "Mi", "Mie", "Mier", "Mir", "Mu", "Na", "Ne", "Ni", "Ny", "O", "Pa", "Pae", "Pe", "Pea", "Pi", "Po", "Ra", "Rae", "Re", "Rey", "Rhe", "Rhi", "Sa", "Se", "Sea", "Sha", "Shae", "Shan", "She", "Shee", "Shi", "Sil", "Sza", "Szi", "Ta", "Tah", "Tal", "Tay", "Te", "Tea", "Tel", "Tem", "Tey", "Tha", "The", "Thi", "Thu", "Ti", "Tie", "Til", "Tra", "Tre", "Tri", "Tu", "U", "Vi", "Ve", "Vei", "Vey", "We", "Wen", "Xi", "Y", "Ya", "Yu", "Za", "Zu"}},
                                               {2, { "a", "ba", "bah", "bae", "baea", "bea", "beth", "bey", "ca", "caea", "cea", "cey", "ci", "cie", "cy", "da", "daea", "dea", "deh", "deth", "di", "dia", "die", "dy", "ea", "fa", "faea", "fea", "fey", "ga", "gaea", "gea", "gie", "gy", "hla", "hlea", "hli", "ja", "jie", "ka", "kaea", "kea", "ki", "kie", "key", "kha", "kka", "la", "laa", "lae", "lan", "las", "lea", "leau", "lee", "lenne", "ley", "lha", "li", "lii", "lia", "lie", "linne", "lis", "lise", "lisse", "lsa", "lse", "lsie", "lsey", "ly", "lya", "lye", "lyse", "lysse", "ma", "maea", "me", "mea", "mey", "mi", "mie", "my", "na", "naea", "nae", "nea", "ni", "nia", "nie", "ney", "ny", "phea", "phia", "phne", "phrea", "ra", "rae", "raea", "rai", "re", "rea", "ri", "ria", "rie", "rhin", "rin", "ry", "rye", "ryn", "sa", "sha", "she", "shi", "shie", "shy", "se", "sey", "si", "sie", "ssa", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xa", "xe", "xi", "xie", "za", "zae", "zea", "zie", "zza", "zy"
                                               } } } } } }
};
...
{
  {
    { 1, { "Ach", "Ad", "Adh", "Adz", "Aech", "Aed", "Ael", "Aer", "Air", "Al", "Ak", "Am", "Amm", "Amn", "An", "Anm", "Ann", "Ap", "Ar", "Arc", "Ard", "Asp", "Ast", "At", "Ath", "Atn", "Au", "Ax", "Az", "Bac", "Bak", "Bal", "Bar", "Bek", "Bel", "Cad", "Ced", "Cam", "Cael", "Caer", "Dam", "Dan", "Dar", "Den", "Dip", "Eil", "El", "Em", "En", "Ex", "Ey", "Eye", "Eyx", "Fal", "Fan", "Far", "Gael", "Gan", "Gel", "Gil", "Gon", "Had", "Hal", "Han", "Har", "Hear", "Hu", "Hur", "Im", "In", "Ix", "Ip", "Kal", "Kam", "Kan", "Kat", "Ket", "Kit", "Ox", "Pad", "Pan", "Ran", "Tam", "Tan", "Tar", "Tet", "Sar", "Scar", "Sel", "Sen", "Skar", "Star", "Ux", "Van", "Var", "Ven", "Vid", "Vir", "Y", "Yad", "Yan", "Yar", "Yd", "Yl", "Ytt", "Yu", "Yukh", "Zeh", "Zo", "Zu", "Zy"}},
    { 2, { "a", "e", "i", "o", "u"}},
    { 3, { "bad", "bae", "bakh", "bal", "bag", "ban", "bank", "bar", "barr", "bat", "bax", "bec", "beck", "bek", "bel", "bey", "bil", "born", "cach", "cal", "can", "car", "crae", "crael", "crel", "dae", "dal", "dan", "den", "dex", "dil", "dim", "din", "dix", "dor", "el", "fal", "fel", "fil", "gal", "gan", "gap", "gel", "gen", "gil", "gon", "gorn", "ham", "han", "hel", "hem", "hen", "kam", "kan", "kar", "kha", "lan", "lin", "mar", "mi", "na", "nae", "nar", "ni", "ra", "ram", "ran", "ren", "rin", "tae", "tam", "tan", "tap", "tar", "tax", "tem", "wan", "well", "wen", "win", "ya", "yan", "yar", "ye", "yil", "za", "zar", "ze"}}
  }
};
