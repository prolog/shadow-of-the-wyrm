...
const SyllableMap Naming::syllables = 
{
  ...
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Dove", "Fay", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Kish", "Lark", "Leah", "Liss", "Liv", "Lyn", "Mab", "Maeve", "Mere", "Nan", "Page", "Pea", "Rae", "Rax", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "South", "Swan", "Tal", "Teek", "Teel", "Tass", "Tesse", "Vi", "West", "Winn", "Wenne", "Wrenne"} } } },
                                        { 2, { {1, { "A", "Ae", "As", "Ba", "Be", "Ca", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Ka", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mae", "Me", "Mea", "Mi", "Mie", "Mir", "Na", "Ne", "Pa", "Pe", "Pi", "Ni", "Sha", "She", "Sza", "Szi", "Ti", "Til", "Te", "Tal", "Tel", "Vi", "Ve", "Wen", "Ya", "Yu"} },
