...
const SyllableMap Naming::syllables = 
{
  ...
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Dove", "Fay", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Kish", "Lark", "Leah", "Liss", "Liv", "Lyn", "Mab", "Maeve", "Mere", "Nan", "Page", "Pea", "Rae", "Rax", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "South", "Swan", "Teek", "Teel", "Tass", "Tesse", "Vi", "West", "Winn", "Wenne", "Wrenne"} } } },
                                        { 2, { {1, { "A", "Ae", "As", "Ba", "Be", "Ca", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Ka", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mae", "Me", "Mea", "Mi", "Mie", "Mir", "Na", "Ne", "Pa", "Pe", "Pi", "Ni", "Sha", "She", "Sza", "Szi", "Ti", "Til", "Te", "Tel", "Vi", "Ve", "Wen", "Ya", "Yu"} },
                                               {2, { "a", "ba", "ca", "cie", "cy", "da", "die", "dy", "ea", "fa", "ka", "kie", "key", "la", "laa", "lha", "lie", "lis", "lise", "lsa", "lse", "lsie", "lsey", "ly", "ma", "mey", "mie", "my", "na", "nae", "nie", "ney", "ny", "phne", "ra", "rae", "ri", "rie", "rra", "ry", "ryn", "sa", "sha", "she", "shi", "shie", "shy", "se", "sey", "sie", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xa", "xe", "xi", "xie",
                                               } } } } } }
};
