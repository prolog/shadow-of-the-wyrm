...
{
  { CreatureSex::CREATURE_SEX_MALE,   { { 1, { {1, { "Aesche", "Arc", "Arke", "Ashe", "Bal", "Bel", "Bane", "Bash", "Bek", "Birch", "Bonn", "Brae", "Cade", "Cael", "Cain", "Cal", "Carr", "Cas", "Cid", "Claye", "Clyne", "Creel", "Clyve", "Col", "Cole", "Corr", "Crane", "Cram", "Crim", "Crom", "Crow", "Crowe", "Cyd", "Dane", "Dax", "Dun", "East", "Elm", "Eorl", "Erne", "Falk", "Fayne", "Finn", "Fil", "Forde", "Froste", "Gael", "Gan", "Garr", "Girn", "Gep", "Heath", "Helm", "Holte", "Howa", "Howe", "Hume", "Jak", "Jek", "Jax", "Jot", "Kharne", "Karr", "Kay", "Kel", "Kerr", "Knot", "Kyp", "Layne", "Lev", "Llew", "Lux", "Mace", "Marr", "Mak", "Mead", "Mill", "Mik", "Miles", "Mirk", "Myrr", "Nashe", "Nodd", "North", "Null", "Nye", "Oak", "Orbe", "Pan", "Pat", "Pax", "Pearne", "Peart", "Pin", "Pine", "Pogg", "Puck", "Quip", "Quinn", "Ran", "Rain", "Rex", "Rhode", "Rhun", "Rhon", "Rock", "Rogue", "Rom", "Rone", "Rushe", "Ryne", "Scrip", "Serg", "Shaw", "Shere", "Slade", "Sloan", "Stave", "Stone", "Stork", "Storm", "Tave", "Tel", "Tep", "Tik", "Tir", "Trayne", "Tull", "Tyg", "Varne", "Vayne", "Vel", "Vim", "Wart", "Wel", "Wink", "Wulf", "Wyld", "Zane", "Zann", "Zog", "Zoq" } } } },
                                        { 2, { {1, { "A", "Ad", "Ae", "Ak", "Ar", "Ash", "Ax", "Az", "Ba", "Bad", "Bal", "Be", "Bel", "Ben", "Bi", "Bil", "Bo", "Bor", "Bra", "Bro", "Brae", "Bran", "Bren", "Bron", "Brun", "Bu", "Ca", "Cal", "Caed", "Cael", "Cap", "Cau", "Ce", "Ced", "Ci", "Cir", "Co", "Com", "Crae", "Cral", "Crel", "Da", "Dae", "De", "Dea", "Di", "Ea", "Ek", "Do", "Fa", "Fau", "Fo", "Feu", "Fu", "Fue", "Gae", "Gea", "Gra", "Grae", "Gre", "Gu", "Gur", "Ha", "Hae", "Hak", "Haz", "He", "Hel", "I", "Ja", "Je", "Jel", "Jo", "Jul", "Ka", "Kae", "Kau", "Ke", "Kea", "Ko", "Kord", "Kra", "La", "Lae", "Le", "Lla", "Lle", "Lli", "Llo", "Llu", "Lo", "Li", "Ma", "Me", "Mu", "Myr", "Na", "Ne", "Nu", "O", "Oe", "Pa", "Pae", "Pal", "Pul", "Po", "Qui", "Ra", "Rae", "Re", "Ru", "Sa", "Se", "Sel", "Su", "Sul", "Ta", "Tau", "Tal", "Te", "Tel", "Teu", "Ti", "Tie", "Tik", "Til", "Tei", "Tu", "Tyg", "U", "Va", "Vi", "Wa", "Wau", "We", "Wi", "Xa", "Xe", "Xen", "Ya", "Ye", "Za", "Ze", "Zi", "Zo", "Zu" } },
                                               {2, { "ac", "ag", "as", "ax", "az", "ban", "bak", "bar", "bax", "baz", "bel", "ben", "bern", "bert", "bik", "cal", "cale", "cel", "den", "el", "ex", "fan", "fax", "fae", "foe", "gan", "gen", "gon", "gonne", "gor", "gul", "iac", "ian", "ic", "im", "ix", "jax", "kal", "kam", "kan", "kel", "kin", "kul", "lac", "lal", "lan", "land", "las", "lale", "lel", "ling", "lon", "lec", "lic", "lone", "lul", "mak", "man", "mar", "max", "men", "mer", "mex", "min", "mon", "mor", "mux", "nak", "nel", "nex", "nul", "nuz", "pul", "pol", "pog", "put", "ran", "rax", "rex", "rix", "ro", "rul", "ryx", "san", "sak", "sir", "sik", "sek", "some", "som", "son", "tag", "tar", "tal", "tel", "ten", "til", "tin", "ton", "tul", "uc", "uck", "ux", "val", "van", "var", "vax", "ver", "vex", "wan", "wen", "win", "wo", "wu", "xar", "yak", "yen", "zak", "zar", "zax", "zel", "zek", "zen", "zo", "zu", "zzo"
                                               } } } } } },
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Bea", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Catte", "Crea", "Cresse", "Dove", "Fae", "Fay", "Fey", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Ia", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Kish", "Lark", "Leah", "Liss", "Liv", "Lyn", "Mab", "Maeve", "Mere", "Nan", "Nea", "Ness", "Page", "Pea", "Rae", "Rax", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shan", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "South", "Swan", "Swaye", "Syd", "Syl", "Taff", "Tal", "Teek", "Teel", "Tass", "Tesse", "Tish", "Vi", "West", "Winn", "Wysp", "Wenne", "Wrenne", "Wy", "Zaye"} } } },
                                        { 2, { {1, { "A", "Ae", "Ai", "Am", "As", "Ash", "Ba", "Be", "Bi", "Ca", "Cae", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Chel", "Cre", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fay", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Je", "Ji", "Ka", "Kal", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mah", "Mar", "Mae", "Me", "Mea", "Mi", "Mie", "Mier", "Mir", "Na", "Ne", "O", "Pa", "Pae", "Pe", "Pi", "Ni", "Sha", "Shae", "Shan", "She", "Shee", "Sza", "Szi", "Ta", "Tah", "Tal", "Te", "Tel", "Tem", "Tey", "Ti", "Tie", "Til", "Tra", "Tre", "Tri", "Tu", "U", "Vi", "Ve", "Wen", "Xi", "Ya", "Yu"} },
                                               {2, { "a", "ba", "ca", "cea", "cey", "ci", "cie", "cy", "da", "di", "dia", "die", "dy", "ea", "fa", "ka", "ki", "kie", "key", "la", "laa", "lan", "las", "lea", "ley", "lha", "li", "lia", "lie", "linne", "lis", "lise", "lisse", "lsa", "lse", "lsie", "lsey", "ly", "lyse", "lysse", "ma", "me", "mea", "mey", "mi", "mie", "my", "na", "nae", "nea", "ni", "nia", "nie", "ney", "ny", "phne", "ra", "rae", "re", "rea", "ri", "ria", "rie", "ry", "ryn", "sa", "sha", "she", "shi", "shie", "shy", "se", "sey", "si", "sie", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xa", "xe", "xi", "xie", "za", "zie", "zza"
                                               } } } } } }
};
...
{
  {
    { 1, { "Ad", "Adz", "Aed", "Aer", "Ak", "Alt", "Ap", "Ax", "Bac", "Bak", "Ban", "Cad", "Cam", "Dam", "Dan", "Dar", "Den", "Dip", "El", "Ex", "Fan", "Far", "Gan", "Gel", "Gil", "Gon", "Had", "Hal", "Han", "Har", "Ix", "Ip", "Kal", "Kan", "Kat", "Ket", "Kit", "Ox", "Pad", "Pan", "Ran", "Tam", "Tar", "Tet", "Sar", "Scar", "Skar", "Star", "Ux", "Var", "Vid", "Vir", "Yad", "Yan", "Yar"} },
    { 2, { "a", "ae", "e", "i", "ii", "o", "da", "dae", "de", "di", "do", "du", "ga", "gae", "ge", "gi", "gil", "go", "la", "lae", "le", "li", "lo", "ra", "rae", "re", "ri", "ro", "ru", "sa", "sae", "se", "si", "so", "su", "ta", "te", "to"} },
    { 3, { "bad", "bae", "bal", "ban", "bar", "bek", "bax", "bex", "bil", "can", "car", "dae", "dan", "den", "dil", "dix", "el", "fil", "gan", "gap", "gel", "gen", "gil", "gon", "ham", "hem", "kam", "kan", "kar", "tam", "tan", "tap", "tax", "tem"}}
  }
};
