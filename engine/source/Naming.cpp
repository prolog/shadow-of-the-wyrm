...
const SyllableMap Naming::syllables = 
{
  ...
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Crea", "Dove", "Fay", "Fey", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Kish", "Lark", "Leah", "Liss", "Liv", "Lyn", "Mab", "Maeve", "Mere", "Nan", "Page", "Pea", "Rae", "Rax", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shan", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "South", "Swan", "Tal", "Teek", "Teel", "Tass", "Tesse", "Tish", "Vi", "West", "Winn", "Wenne", "Wrenne"} } } },
                                        { 2, { {1, { "A", "Ae", "As", "Ba", "Be", "Ca", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fay", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Je", "Ji", "Ka", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mah", "Mar", "Mae", "Me", "Mea", "Mi", "Mie", "Mir", "Na", "Ne", "Pa", "Pae", "Pe", "Pi", "Ni", "Sha", "She", "Sza", "Szi", "Ta", "Tah", "Tal", "Te", "Tel", "Tem", "Tey", "Ti", "Tie", "Til", "Tu", "U", "Vi", "Ve", "Wen", "Xi", "Ya", "Yu"} },
                                               {2, { "a", "ba", "ca", "ci", "cie", "cy", "da", "di", "die", "dy", "ea", "fa", "ka", "kie", "key", "la", "laa", "lha", "li", "lie", "lis", "lise", "lsa", "lse", "lsie", "lsey", "ly", "ma", "me", "mey", "mi", "mie", "my", "na", "nae", "ni", "nie", "ney", "ny", "phne", "ra", "rae", "re", "ri", "rie", "rra", "ry", "ryn", "sa", "sha", "she", "shi", "shie", "shy", "se", "sey", "si", "sie", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xa", "xe", "xi", "xie",
                                               } } } } } }
};
