...
const SyllableMap Naming::syllables = 
{
  ...
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Crea", "Cresse", "Dove", "Fae", "Fay", "Fey", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Ia", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Kish", "Lark", "Leah", "Liss", "Liv", "Lyn", "Mab", "Maeve", "Mere", "Nan", "Nea", "Ness", "Page", "Pea", "Rae", "Rax", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shan", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "South", "Swan", "Swaye", "Taff", "Tal", "Teek", "Teel", "Tass", "Tesse", "Tish", "Vi", "West", "Winn", "Wenne", "Wrenne", "Wy", "Zaye"} } } },
                                        { 2, { {1, { "A", "Ae", "Ai", "As", "Ash", "Ba", "Be", "Bi", "Ca", "Cae", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Chel", "Cre", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fay", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Je", "Ji", "Ka", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mah", "Mar", "Mae", "Me", "Mea", "Mi", "Mie", "Mier", "Mir", "Na", "Ne", "O", "Pa", "Pae", "Pe", "Pi", "Ni", "Sha", "Shae", "Shan", "She", "Sza", "Szi", "Ta", "Tah", "Tal", "Te", "Tel", "Tem", "Tey", "Ti", "Tie", "Til", "Tra", "Tre", "Tri", "Tu", "U", "Vi", "Ve", "Wen", "Xi", "Ya", "Yu"} },
                                               {2, { "a", "ba", "ca", "ci", "cie", "cy", "da", "di", "die", "dy", "ea", "fa", "ka", "kie", "key", "la", "laa", "las", "lha", "ley", "li", "lie", "linne", "lis", "lise", "lisse", "lsa", "lse", "lsie", "lsey", "ly", "lyse", "lysse", "ma", "me", "mey", "mi", "mie", "my", "na", "nae", "ni", "nie", "ney", "ny", "phne", "ra", "rae", "re", "ri", "ria", "rie", "ry", "ryn", "sa", "sha", "she", "shi", "shie", "shy", "se", "sey", "si", "sie", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xa", "xe", "xi", "xie",
                                               } } } } } }
};
...
{
  {
    { 1, { "Ad", "Aed", "Aer", "Alt", "Ap", "Ax", "Bac", "Bak", "Ban", "Cad", "Cam", "Dam", "Dan", "Dar", "Den", "Dip", "El", "Ex", "Fan", "Far", "Gan", "Gel", "Gil", "Gon", "Had", "Hal", "Han", "Har", "Ix", "Ip", "Kal", "Kan", "Kat", "Ket", "Kit", "Ox", "Pad", "Pan", "Ran", "Tam", "Tar", "Tet", "Sar", "Scar", "Skar", "Star", "Ux", "Var", "Vid", "Vir", "Yad", "Yan", "Yar"} },
    { 2, { "a", "ae", "e", "i", "o", "da", "dae", "de", "di", "do", "du", "ga", "gae", "ge", "gi", "gil", "go", "la", "lae", "le", "li", "lo", "ra", "rae", "re", "ri", "ro", "ru", "sa", "sae", "se", "si", "so", "su", "ta", "te", "to"} },
    { 3, { "bad", "bal", "ban", "bex", "bil", "can", "car", "dan", "den", "dil", "dix", "el", "fil", "gan", "gap", "gel", "gen", "gil", "gon", "ham", "hem", "kam", "kan", "kar", "tam", "tan", "tap", "tax", "tem"}}
  }
};
