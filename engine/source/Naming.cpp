...
{
  { CreatureSex::CREATURE_SEX_MALE,   { { 1, { {1, { "Aesche", "Arc", "Arke", "Ashe", "Bel", "Bane", "Bash", "Bek", "Birch", "Bonn", "Brae", "Cade", "Cael", "Cain", "Carr", "Cid", "Claye", "Clyne", "Creel", "Clyve", "Col", "Cole", "Corr", "Crane", "Crim", "Crow", "Crowe", "Cyd", "Dane", "Dax", "Dun", "East", "Elm", "Eorl", "Erne", "Falk", "Fayne", "Finn", "Fil", "Forde", "Froste", "Gael", "Gan", "Garr", "Girn", "Gep", "Heath", "Holte", "Howe", "Hume", "Jak", "Jek", "Jax", "Jot", "Karr", "Kay", "Kel", "Kerr", "Knot", "Kyp", "Layne", "Lev", "Llew", "Lux", "Mace", "Marr", "Mak", "Mead", "Mill", "Mik", "Miles", "Mirk", "Myrr", "Nashe", "Nodd", "North", "Null", "Nye", "Oak", "Orbe", "Pan", "Pax", "Pearne", "Peart", "Pin", "Pine", "Pogg", "Puck", "Quip", "Quinn", "Ran", "Rain", "Rex", "Rhode", "Rhun", "Rhon", "Rock", "Rogue", "Rom", "Rone", "Rushe", "Ryne", "Scrip", "Serg", "Shaw", "Shere", "Slade", "Sloan", "Stave", "Stone", "Stork", "Storm", "Tave", "Tel", "Tep", "Tik", "Tir", "Tull", "Varne", "Vayne", "Vel", "Vim", "Wart", "Wel", "Wulf", "Zog", "Zoq" } } } },
                                        { 2, { {1, { "A", "Ae", "Ash", "Ba", "Bal", "Be", "Bel", "Ben", "Bi", "Bil", "Bo", "Bor", "Bro", "Brae", "Bran", "Bren", "Bron", "Brun", "Bu", "Ca", "Cal", "Caed", "Cael", "Cau", "Ce", "Ced", "Ci", "Co", "Com", "Crae", "Cral", "Crel", "Da", "Dae", "De", "Di", "Ea", "Ek", "Do", "Fa", "Fo", "Fu", "Gae", "Gea", "Gu", "Gur", "Ha", "Hae", "He", "Hel", "Ja", "Je", "Jel", "Jo", "Jul", "Ka", "Kae", "Kau", "Ke", "Kea", "Ko", "Kord", "Kra", "La", "Lae", "Le", "Lo", "Li", "Ma", "Me", "Mu", "Myr", "Na", "Ne", "Nu", "Oe", "Pa", "Pae", "Pal", "Pul", "Po", "Qui", "Ra", "Rae", "Re", "Ru", "Sa", "Se", "Sel", "Su", "Sul", "Ta", "Tau", "Tal", "Te", "Tel", "Teu", "Ti", "Tie", "Tik", "Til", "Tei", "Tu", "U", "Va", "Vi", "Wa", "Wau", "We", "Wi", "Xa", "Xe", "Xen", "Ya", "Ye", "Za", "Ze", "Zi", "Zo", "Zu" } },
                                               {2, { "ac", "ag", "ax", "bel", "ben", "bik", "cal", "cale", "cel", "den", "ex", "fan", "fax", "fae", "foe", "gan", "gen", "gon", "gonne", "gor", "gul", "iac", "ian", "ic", "im", "ix", "jax", "kal", "kam", "kan", "kel", "kin", "kul", "lal", "lan", "land", "las", "lale", "lel", "lon", "lec", "lic", "lone", "lul", "mak", "man", "mar", "men", "mer", "mex", "min", "mon", "mor", "mux", "nak", "nel", "nex", "nul", "nuz", "pul", "pol", "pog", "put", "ran", "rax", "rex", "rix", "ro", "rul", "san", "sak", "sir", "sik", "sek", "some", "som", "son", "tag", "tar", "tal", "tel", "ten", "til", "tin", "ton", "tul", "uc", "uck", "ux", "val", "van", "var", "vax", "ver", "vex", "wan", "wen", "win", "xar", "yak", "yen", "zar", "zel", "zek"
                                               } } } } } },
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Crea", "Dove", "Fay", "Fey", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Kish", "Lark", "Leah", "Liss", "Liv", "Lyn", "Mab", "Maeve", "Mere", "Nan", "Page", "Pea", "Rae", "Rax", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shan", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "South", "Swan", "Tal", "Teek", "Teel", "Tass", "Tesse", "Tish", "Vi", "West", "Winn", "Wenne", "Wrenne"} } } },
                                        { 2, { {1, { "A", "Ae", "As", "Ba", "Be", "Ca", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fay", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Je", "Ji", "Ka", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mae", "Me", "Mea", "Mi", "Mie", "Mir", "Na", "Ne", "Pa", "Pe", "Pi", "Ni", "Sha", "She", "Sza", "Szi", "Ta", "Ti", "Tie", "Til", "Te", "Tey", "Tal", "Tel", "Tem", "U", "Vi", "Ve", "Wen", "Xi", "Ya", "Yu"} },
                                               {2, { "a", "ba", "ca", "cie", "cy", "da", "di", "die", "dy", "ea", "fa", "ka", "kie", "key", "la", "laa", "lha", "li", "lie", "lis", "lise", "lsa", "lse", "lsie", "lsey", "ly", "ma", "me", "mey", "mi", "mie", "my", "na", "nae", "ni", "nie", "ney", "ny", "phne", "ra", "rae", "re", "ri", "rie", "rra", "ry", "ryn", "sa", "sha", "she", "shi", "shie", "shy", "se", "sey", "si", "sie", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xa", "xe", "xi", "xie",
                                               } } } } } }
};
