...
const SyllableMap Naming::syllables = 
{
  { CreatureSex::CREATURE_SEX_MALE,   { { 1, { {1, { "Arc", "Ashe", "Bel", "Bane", "Bash", "Bek", "Birch", "Bonn", "Cade", "Cael", "Cain", "Carr", "Cid", "Claye", "Clyve", "Col", "Cole", "Crane", "Cyd", "Dane", "Dax", "Dun", "Eorl", "Erne", "Falk", "Fayne", "Finn", "Fil", "Forde", "Froste", "Gael", "Gan", "Garr", "Girn", "Gep", "Heath", "Holte", "Howe", "Hume", "Jak", "Jek", "Jax", "Jot", "Karr", "Kay", "Kerr", "Knot", "Kyp", "Layne", "Lev", "Llew", "Lux", "Mace", "Marr", "Mak", "Mead", "Mill", "Mik", "Miles", "Nashe", "North", "Null", "Nye", "Oak", "Orbe", "Pax", "Peart", "Pin", "Pine", "Puck", "Quip", "Quinn", "Rain", "Rex", "Rhode", "Rock", "Rogue", "Rushe", "Serg", "Shaw", "Slade", "Sloan", "Stone", "Storm", "Tave", "Tel", "Tep", "Tir", "Tull", "Varne", "Vayne", "Vel", "Vim", "Wart", "Wel", "Wulf" } } } },
                                        { 2, { {1, { "A", "Ba", "Be", "Bi", "Bo", "Ca", "Ce", "Ci", "Co", "Da", "De", "Di", "Do", "Fa", "Fi", "Fo", "Fu", "Gae", "Hae", "Ja", "Je", "Jo", "Ka", "Ke", "Ko", "La", "Le", "Lo", "Li", "Ma", "Me", "Mu", "Na", "Ne", "Nu", "Pa", "Po", "Qui", "Ra", "Re", "Ru", "Sa", "Se", "Su", "Ta", "Teu", "Ti", "Tu", "U", "Va", "Vi", "Wa", "We", "Wi", "Za", "Ze" } },
                                               {2, { "bel", "ben", "bik", "cal", "cel", "den", "fan", "fax", "gor", "gul", "jax", "kal", "kel", "kul", "lal", "lel", "lon", "lul", "mak", "mar", "mer", "mex", "mux", "nak", "nel", "nex", "nul", "nuz", "pul", "pol", "pog", "put", "rax", "rex", "rul", "san", "sak", "sir", "sik", "sek", "tag", "tar", "tal", "tel", "ten", "til", "tin", "ton", "tul", "val", "van", "var", "vax", "ver", "vex", "wan", "wen", "win", "xar", "yak", "yen", "zar", "zel", "zek"
                                               } } } } } },
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Brig", "Bron", "Bree", "Brea", "Cat", "Fay", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Jass", "Jil", "Kat", "Kai", "Lark", "Liv", "Lyn", "Mab", "Mere", "Nan", "Page", "Ros", "Rue", "Sage", "Shaye", "Scout", "Shal", "Skye", "Teeg", "Teel", "Tass", "Vi", "Winn", "Wrenne"} } } },
                                        { 2, { {1, { "A", "Cha", "Che", "E", "I", "Ka", "Ke", "Ki", "Ma", "Me", "Mi", "Na", "Ne", "Ti", "Til", "Tel", "Vi", "Ve", "Wen", "Ya", "Yu"} },
                                               {2, { "ca", "cy", "da", "dy", "lie", "lsa", "lse", "lsie", "mie", "na", "ny", "phne", "ra", "ri", "ry", "sa", "se", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xie", 
                                               } } } } } }
};
