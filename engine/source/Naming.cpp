...
const SyllableMap Naming::syllables = 
{
  ...
  { CreatureSex::CREATURE_SEX_FEMALE, { { 1, { {1, { "Aenn", "Ash", "Brig", "Belle", "Bron", "Brie", "Bree", "Brea", "Cass", "Cat", "Dove", "Fay", "Ferne", "Gaile", "Grace", "Hail", "Hil", "Hild", "Hilde", "Hope", "Jass", "Jil", "Kat", "Joye", "Kai", "Kess", "Kell", "Lark", "Leah", "Liv", "Lyn", "Mab", "Mere", "Nan", "Page", "Ros", "Rhenne", "Rue", "Sage", "Scout", "Shal", "Shae", "Shale", "Shay", "Shaye", "Shel", "Shelle", "Shrike", "Skye", "Swan", "Teek", "Teel", "Tass", "Tesse", "Vi", "Winn", "Wenne", "Wrenne"} } } },
                                        { 2, { {1, { "A", "As", "Ba", "Be", "Ca", "Ce", "Cen", "Cal", "Cha", "Chal", "Che", "Da", "De", "Del", "E", "Ei", "El", "Fa", "Fae", "Fe", "Fen", "Fey", "Fi", "Ga", "Gae", "Ge", "Gi", "Gie", "I", "Ie", "Ka", "Ke", "Kel", "Ki", "Kie", "Key", "Ma", "Mae", "Me", "Mi", "Mie", "Na", "Ne", "Pa", "Pe", "Pi", "Ni", "Sha", "She", "Ti", "Til", "Te", "Tel", "Vi", "Ve", "Wen", "Ya", "Yu"} },
                                               {2, { "ca", "cie", "cy", "da", "die", "dy", "la", "laa", "lha", "lie", "lsa", "lse", "lsie", "lsey", "ly", "ma", "mey", "mie", "my", "na", "nae", "nie", "ney", "ny", "phne", "ra", "rae", "ri", "rie", "rra", "ry", "sa", "sha", "she", "shi", "shie", "se", "sey", "sie", "ta", "tie", "ty", "va", "vie", "vy", "ya", "xi", "xie",
                                               } } } } } }
};
