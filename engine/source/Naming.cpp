...
{
  {
    { 1, { "Ach", "Ad", "Adz", "Aed", "Ael", "Aer", "Al", "Ak", "Am", "Amn", "An", "Ann", "Ap", "Ar", "Arc", "Ard", "Ast", "At", "Atn", "Au", "Ax", "Az", "Bac", "Bak", "Bal", "Bek", "Ban", "Bel", "Cad", "Ced", "Cam", "Cael", "Caer", "Dam", "Dan", "Dar", "Den", "Dip", "Eil", "El", "Ex", "Ey", "Eye", "Eyx", "Fal", "Fan", "Far", "Gael", "Gan", "Gel", "Gil", "Gon", "Had", "Hal", "Han", "Har", "Hear", "Hu", "Hur", "Ix", "Ip", "Kal", "Kam", "Kan", "Kat", "Ket", "Kit", "Ox", "Pad", "Pan", "Ran", "Tam", "Tan", "Tar", "Tet", "Sar", "Scar", "Sel", "Sen", "Skar", "Star", "Ux", "Van", "Var", "Ven", "Vid", "Vir", "Y", "Yad", "Yan", "Yar", "Yd", "Ytt", "Zo", "Zu", "Zy"}},
    { 2, { "a", "e", "i", "o", "u"}},
    { 3, { "bad", "bae", "bakh", "bal", "bag", "ban", "bar", "bat", "bax", "beck", "bek", "bel", "bey", "bil", "cach", "cal", "can", "car", "crae", "dae", "dan", "den", "dex", "dil", "dix", "dor", "el", "fil", "gal", "gan", "gap", "gel", "gen", "gil", "gon", "ham", "han", "hel", "hem", "hen", "kam", "kan", "kar", "kha", "lan", "lin", "mar", "mi", "na", "nae", "nar", "ni", "ram", "ran", "ren", "rin", "tae", "tam", "tan", "tap", "tar", "tax", "tem", "wan", "well", "wen", "win", "ya", "yan", "yar", "ye", "yil", "za", "zar", "ze"}}
  }
};
