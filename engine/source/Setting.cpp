...
const string Setting::DISPLAY_SETTING_COLOUR = "display_colour";
const string Setting::DISPLAY_SETTING_MONOCHROME_COLOUR = "monochrome_colour";
const string Setting::DISPLAY_SETTING_CURSOR_MODE = "cursor_mode";
...
const string Setting::PERIODICALLY_UPDATE_CREATURES = "periodically_update_creatures";
