...
typedef std::pair<std::string, std::pair<boost::shared_ptr<Item>, GenerationValues> > ItemGenerationPair;
...
class ItemGenerationManager
{
  public:
    ...
    boost::shared_ptr<Item> generate_item(ActionManager& am, ItemGenerationVec& item_generation_vec);
