...
class CreaturePietyRegeneration : public ICreatureRegeneration
{
  ...
  protected:
    int regenerate_piety(const int piety, const ulonglong minutes_elapsed, const bool crowned);
    int degenerate_piety(const int piety, const ulonglong minutes_elapsed);
