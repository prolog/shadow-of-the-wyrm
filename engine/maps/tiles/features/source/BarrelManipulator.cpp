...
void BarrelManipulator::strike(CreaturePtr creature, MapPtr /*current_map*/, TilePtr /*feature_tile*/, const Coordinate& /*feature_coord*/, FeaturePtr /*feature*/)
{
...
bool BarrelManipulator::handle(TilePtr tile, CreaturePtr creature)
{
  ...
  if (barrel != nullptr)
  {
    if (creature && barrel->get_tap())
    {
      ...
      {
        IMessageManager& pl_manager = MMF::instance(MessageTransmit::SELF, creature, creature && creature->get_is_player());
