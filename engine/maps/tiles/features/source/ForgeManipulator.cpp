...
void ForgeManipulator::strike(CreaturePtr creature, MapPtr /*current_map*/, TilePtr /*feature_tile*/, const Coordinate& /*feature_coord*/, FeaturePtr /*feature*/)
{
...
ItemPtr ForgeManipulator::get_selected_item(CreaturePtr creature, ItemPtr selected_ingot, ActionManager& am)
{
  ...
  ItemPtr selected_item = am.inventory(creature, creature->get_inventory(), smithable_item_list, {}, false, false);
