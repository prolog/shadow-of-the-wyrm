...
class InventoryManager : public IActionManager
{
  public:
    ...
    ItemPtr manage_inventory(IInventoryPtr inv, const std::list<IItemFilterPtr>& base_display_filter_list, const std::list<IItemFilterPtr>& additional_display_filter_list, const bool inventory_is_read_only, const bool allow_multiple_selected_items);
