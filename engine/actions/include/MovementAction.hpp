...
class MovementAction : public IActionManager
{
  ...
  protected:
    ...
    ActionCostValue generate_and_move_to_new_map(CreaturePtr creature, MapPtr map, TilePtr tile, const TileType TileType::TILE_TYPE, const TileType tile_subtype, const int depth_increment = 0);
