...
class EvokeAction : public IActionManager
{
  ...
  protected:
    ...
    bool process_wand_damage_and_effect(CreaturePtr creature, MapPtr map, const Coordinate& caster_coord, const Direction spell_direction, const Spell& wand_spell, const ItemStatus wand_status, const uint original_charges);
