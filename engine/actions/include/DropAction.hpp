...
class DropAction : public IActionManager
{
  ...
  protected:
    ...
    void handle_item_dropped_message(CreaturePtr creature, IInventoryPtr inv, ItemPtr item, const bool unstable);
    ...
    bool bury_remains(CreaturePtr creature, const std::string& remains_race_id, const uint quantity, TilePtr tile, MapPtr current_map);
    ...
    bool build_wall_with_dropped_item(CreaturePtr creature, MapPtr map, const TileType wall_tile_type, const bool allow_build_on_water);
