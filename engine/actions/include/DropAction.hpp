...
class DropAction : public IActionManager
{
  ...
  protected:
    ...
    bool build_with_dropped_item(CreaturePtr creature, MapPtr map, TilePtr tile, const bool building_material, const std::string& wall_tile_type_s, const std::string& floor_tile_type_s, const std::string& water_tile_type, const std::string& feature_ids);
