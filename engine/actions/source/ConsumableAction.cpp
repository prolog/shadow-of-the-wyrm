...
// and its grams of pure alcohol (based on the number of standard drinks)
// to the creature's grams of unabsorbed alcohol.
ActionCostValue ConsumableAction::consume(CreaturePtr creature, ConsumablePtr consumable)
{
  ...
  if (creature && consumable)
  {
    ...
    creature->increment_grams_unabsorbed_alcohol(AlcoholConverter::standard_drinks_to_grams(consumable->get_standard_drinks()));
  }
