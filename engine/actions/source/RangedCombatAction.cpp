...
bool RangedCombatAction::operator==(const RangedCombatAction& rca)
{
  return true;
}
...
bool RangedCombatAction::has_ranged_combat_target(CreaturePtr creature)
{
...
void RangedCombatAction::select_nearest_hostile_target(CreaturePtr creature, MapPtr map)
{
  if (creature && map)
  {
...
// map.
void RangedCombatAction::select_existing_target(CreaturePtr creature, MapPtr map)
{
