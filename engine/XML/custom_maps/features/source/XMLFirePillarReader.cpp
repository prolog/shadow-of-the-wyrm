...
FeaturePtr XMLFirePillarReader::create(const XMLNode& fire_pillar_node) const
{
  ...
  MaterialType material = static_cast<MaterialType>(XMLUtils::get_child_node_int_value(fire_pillar_node, "Material", static_cast<int>(MaterialType::MATERIAL_TYPE_STONE)));
