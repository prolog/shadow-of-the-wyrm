...
void XMLToolReader::parse(ToolPtr tool, GenerationValues& gv, const XMLNode& tool_node, const bool force_ascii)
{
  if (!tool_node.is_null())
  {
    XMLItemReader::parse(tool, gv, tool_node, force_ascii);
