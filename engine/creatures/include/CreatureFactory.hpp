...
class CreatureFactory
{
  ...
  protected:
    ...
    void set_initial_statistics(CreaturePtr creature, Race* race, ClassPtr char_class, Deity* deity);
    ...
    void set_initial_resistances(CreaturePtr creature, Race* race, ClassPtr char_class);
    void set_initial_skills(CreaturePtr creature, Race* race, ClassPtr char_class);
