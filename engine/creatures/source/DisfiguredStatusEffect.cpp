...
Modifier DisfiguredStatusEffect::get_base_modifier(CreaturePtr creature, const int danger_level) const
{
  Modifier m;
  ...
  if (RNG::percent_chance(25))
  {
    ...
    reduce_amount = static_cast<int>(RNG::range(static_cast<int>(stat_cur * r_mults.first), static_cast<int>(stat_cur * r_mults.second))) * -1;
