...
class NPCDecisionStrategy : public DecisionStrategy
{
  public:
    ...
    virtual CommandPtr get_decision(const bool reprompt_on_cmd_not_found, const std::string& this_creature_id, CommandFactory* command_factory, KeyboardCommandMapPtr keyboard_commands, MapPtr view_map = nullptr, int* key_p = 0) override;
    virtual CommandPtr get_nonmap_decision(const bool reprompt_on_cmd_not_found, const std::string& this_creature_id, CommandFactory* command_factory, KeyboardCommandMapPtr keyboard_commands, int* key_p) override;
  ...
  protected:
    ...
    virtual CommandPtr get_decision_for_map(const std::string& this_creature_id, CommandFactory* command_factory, KeyboardCommandMapPtr keyboard_commands, MapPtr view_map);
    ...
    virtual CommandPtr get_decision_for_inventory(CommandFactory* command_factory, KeyboardCommandMapPtr keyboard_commands) = 0;
    virtual CommandPtr get_decision_for_equipment(CommandFactory* command_factory, KeyboardCommandMapPtr keyboard_commands) = 0; 
    virtual CommandPtr get_decision_for_tile_selection(CommandFactory* command_factory, KeyboardCommandMapPtr keyboard_commands) = 0;
