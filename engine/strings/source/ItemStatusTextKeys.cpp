...
void ItemStatusTextKeys::initialize_item_status_string_map()
{
  ...
  item_status_string_map = std::map<ItemStatus, std::string>{{ItemStatus::ITEM_STATUS_BLESSED, ItemStatusTextKeys::STATUS_BLESSED},
                                                             {ItemStatus::ITEM_STATUS_UNCURSED, ItemStatusTextKeys::STATUS_UNCURSED},
                                                             {ItemStatus::ITEM_STATUS_CURSED, ItemStatusTextKeys::STATUS_CURSED}};
}
