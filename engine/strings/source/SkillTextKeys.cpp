...
const string SkillTextKeys::SKILL_GENERAL_MOUNTAINEERING_DETAILS = "SKILL_GENERAL_MOUNTAINEERING_DETAILS";
...
const string SkillTextKeys::SKILL_USAGE_MOUNTAINEERING = "SKILL_USAGE_MOUNTAINEERING";
