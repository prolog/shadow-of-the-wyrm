...
const string TextKeys::DECISION_SAVE_AND_THEN_QUIT = "DECISION_SAVE_AND_THEN_QUIT";
...
const string TextKeys::EFFECT_IMMUNITIES = "EFFECT_IMMUNITIES";
const string TextKeys::RECIPES = "RECIPES";
const string TextKeys::BACKSTABBED = "BACKSTABBED";
const string TextKeys::SKILL_REQUIRED = "SKILL_REQUIRED";
