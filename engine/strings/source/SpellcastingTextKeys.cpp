...
const string SpellcastingTextKeys::SPELLCASTING_DIVINE_MAGIC_NO_DEITIES = "SPELLCASTING_DIVINE_MAGIC_NO_DEITIES";
...
const string SpellcastingTextKeys::SPELLCASTING_READ_WORLD_MAP = "SPELLCASTING_READ_WORLD_MAP";
