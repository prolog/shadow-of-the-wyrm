...
const string ActionTextKeys::ACTION_BREWING_INGREDIENTS        = "ACTION_BREWING_INGREDIENTS";
const string ActionTextKeys::ACTION_BREWING_NO_INGREDIENTS     = "ACTION_BREWING_NO_INGREDIENTS";
const string ActionTextKeys::ACTION_BREWING_COMBINE_INGREDIENTS = "ACTION_BREWING_COMBINE_INGREDIENTS";
...
const string ActionTextKeys::ACTION_STRIKE_KILN                = "ACTION_STRIKE_KILN";
const string ActionTextKeys::ACTION_STRIKE_FORGE               = "ACTION_STRIKE_FORGE";
const string ActionTextKeys::ACTION_STRIKE_JEWELER_WORKBENCH   = "ACTION_STRIKE_JEWELER_WORKBENCH";
const string ActionTextKeys::ACTION_STRIKE_TANNERY             = "ACTION_STRIKE_TANNERY";
const string ActionTextKeys::ACTION_STRIKE_CAULDRON            = "ACTION_STRIKE_CAULDRON";
const string ActionTextKeys::ACTION_STRIKE_HIVE                = "ACTION_STRIKE_HIVE";
const string ActionTextKeys::ACTION_STRIKE_HIVE_EMPTY          = "ACTION_STRIKE_HIVE_EMPTY";
const string ActionTextKeys::ACTION_STRIKE_PULPER              = "ACTION_STRIKE_PULPER";
const string ActionTextKeys::ACTION_STRIKE_WHEEL_AND_LOOM      = "ACTION_STRIKE_WHEEL_AND_LOOM";
const string ActionTextKeys::ACTION_STRIKE_BARREL              = "ACTION_STRIKE_BARREL";
const string ActionTextKeys::ACTION_STRIKE_SARCOPHAGUS         = "ACTION_STRIKE_SARCOPHAGUS";
const string ActionTextKeys::ACTION_STRIKE_TRAP                = "ACTION_STRIKE_TRAP";
const string ActionTextKeys::ACTION_KICK_PASSES_THROUGH        = "ACTION_KICK_PASSES_THROUGH";
const string ActionTextKeys::ACTION_STRIKE_DOOR_DESTROYED      = "ACTION_STRIKE_DOOR_DESTROYED";
const string ActionTextKeys::ACTION_STRIKE_DOOR_BUCKLED        = "ACTION_STRIKE_DOOR_BUCKLED";
const string ActionTextKeys::ACTION_STRIKE_DOOR_UNMOVED        = "ACTION_STRIKE_DOOR_UNMOVED";
const string ActionTextKeys::ACTION_STRIKE_DOOR_CLOSED         = "ACTION_STRIKE_DOOR_CLOSED";
const string ActionTextKeys::ACTION_STRIKE_TABLE               = "ACTION_STRIKE_TABLE";
const string ActionTextKeys::ACTION_STRIKE_SLOT_MACHINE        = "ACTION_STRIKE_SLOT_MACHINE";
...
const string ActionTextKeys::ACTION_SHAKE_HIVE                 = "ACTION_SHAKE_HIVE";
