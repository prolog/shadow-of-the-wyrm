...
const string ActionTextKeys::ACTION_KICK_CAULDRON              = "ACTION_KICK_CAULDRON";
const string ActionTextKeys::ACTION_KICK_HIVE                  = "ACTION_KICK_HIVE";
const string ActionTextKeys::ACTION_KICK_HIVE_EMPTY            = "ACTION_KICK_HIVE_EMPTY";
