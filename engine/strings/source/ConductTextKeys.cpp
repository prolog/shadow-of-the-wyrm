...
{
  conduct_message_sids = {"CONDUCT_MESSAGE_FOODLESS", "CONDUCT_MESSAGE_VEGETARIAN", "CONDUCT_MESSAGE_CORPSELESS", "CONDUCT_MESSAGE_AGNOSTIC", "CONDUCT_MESSAGE_ILLITERATE", "CONDUCT_MESSAGE_WEAPONLESS", "CONDUCT_MESSAGE_NO_GRAVEDIGGING", "CONDUCT_MESSAGE_QUESTLESS", "CONDUCT_MESSAGE_SILENT"};
}
