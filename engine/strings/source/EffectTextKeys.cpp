...
const string EffectTextKeys::EFFECT_SUMMON_TRAPS = "EFFECT_SUMMON_TRAPS";
...
const string EffectTextKeys::EFFECT_INCREASE_MAX_HP_PLAYER = "EFFECT_INCREASE_MAX_HP_PLAYER";
