...
= {"INSCRIPTION_USEFUL_1",
   ...
   "INSCRIPTION_USEFUL_15",
   "INSCRIPTION_USEFUL_16",
   "INSCRIPTION_USEFUL_17",
   "INSCRIPTION_USEFUL_18"};
...
= {"INSCRIPTION_USELESS_1",
   ...
   "INSCRIPTION_USELESS_15",
   "INSCRIPTION_USELESS_16",
   "INSCRIPTION_USELESS_17",
   "INSCRIPTION_USELESS_18"};

const int InscriptionTextKeys::PCT_CHANCE_USEFUL_INSCRIPTION = 65;
