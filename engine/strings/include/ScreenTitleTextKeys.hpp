...
class ScreenTitleTextKeys
{
  public:
    static const std::string SCREEN_TITLE_QUEST_LIST;
    ...
    static const std::string SCREEN_TITLE_STRATEGY_BASICS;
    ...
    static const std::string SCREEN_TITLE_SOUND_ACTIONS;
    ...
    static const std::string SCREEN_TITLE_BUILD;
    static const std::string SCREEN_TITLE_RECIPES;
