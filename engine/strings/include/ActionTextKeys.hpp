...
class ActionTextKeys
{
  public:
    ...
    static const std::string ACTION_STRIKE_KILN;
    static const std::string ACTION_STRIKE_FORGE;
    static const std::string ACTION_STRIKE_JEWELER_WORKBENCH;
    static const std::string ACTION_STRIKE_TANNERY;
    static const std::string ACTION_STRIKE_CAULDRON;
    static const std::string ACTION_STRIKE_HIVE;
    static const std::string ACTION_STRIKE_HIVE_EMPTY;
    static const std::string ACTION_STRIKE_PULPER;
    static const std::string ACTION_STRIKE_WHEEL_AND_LOOM;
    static const std::string ACTION_STRIKE_BARREL;
    static const std::string ACTION_STRIKE_SARCOPHAGUS;
    static const std::string ACTION_STRIKE_TRAP;
    static const std::string ACTION_KICK_PASSES_THROUGH;
    static const std::string ACTION_STRIKE_DOOR_DESTROYED;
    static const std::string ACTION_STRIKE_DOOR_BUCKLED;
    static const std::string ACTION_STRIKE_DOOR_UNMOVED;
    static const std::string ACTION_STRIKE_DOOR_CLOSED;
    static const std::string ACTION_STRIKE_TABLE;
    static const std::string ACTION_STRIKE_SLOT_MACHINE;
