...
vector<pair<Coordinate, TilePtr> > BeamShapeProcessor::get_affected_tiles_for_spell(MapPtr map, const Coordinate& caster_coord, const Direction d, const Spell& spell)
{
  ...
  for (uint i = 0; i < range; i++)
  {
    ...
    current_coord = c;
    affected_tiles.push_back(make_pair(current_coord, tile));
  }
