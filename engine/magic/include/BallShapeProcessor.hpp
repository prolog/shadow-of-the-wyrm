...
class BallShapeProcessor : public SpellShapeProcessor
{
  public:
    ...
    virtual std::pair<std::vector<std::pair<Coordinate, TilePtr>>, MovementPath> get_affected_coords_and_tiles(MapPtr map, const Spell& spell, const Coordinate& caster_coordinate);
};
