...
class MapTranslator
{
  public:
    ...
    static DisplayTile create_display_tile(const bool player_blinded, const std::pair<Colour, Colour>& tod_overrides, const TilePtr& engine_tile, const TilePtr& fov_tile);
    static DisplayTile create_display_tile_from_creature(const CreaturePtr& creature, const Colour override_colour);
    static DisplayTile create_display_tile_from_feature(const FeaturePtr& feature, const Colour override_colour);
    static DisplayTile create_display_tile_from_item(const ItemPtr& item, const Colour override_colour);
    static DisplayTile create_display_tile_from_tile(const TilePtr& tile, const Colour override_colour);
  ...
  protected:
    ...
    static DisplayTile translate_coordinate_into_display_tile(const bool player_blinded, const std::pair<Colour, Colour>& tod_overrides, const MapPtr& map, const MapPtr& fov_map, const int actual_row, const int actual_col);

    // For fields outside of the FOV
    static DisplayTile create_unseen_and_previously_viewed_display_tile(const TilePtr& tile, const std::pair<Colour, Colour>& tod_overrides);
    static DisplayTile create_unseen_and_explored_display_tile(const TilePtr& tile, const std::pair<Colour, Colour>& tod_overrides);
