...
class MapTranslator
{
  public:
    ...
    static DisplayTile create_display_tile(const bool player_blinded, const bool timewalking, const std::pair<Colour, Colour>& tod_overrides, const ShimmerColours& shimmer_colours, const TilePtr& engine_tile, const TilePtr& fov_tile, const int row, const int col);
    ...
    static DisplayTile create_display_tile_from_tile(const TilePtr& tile, const bool timewalking, const std::pair<Colour, Colour> override_colours, const ShimmerColours& shimmer_colours, const int row, const int col);
  ...
  protected:
    ...
    static DisplayTile create_unseen_and_previously_viewed_display_tile(const TilePtr& tile, const bool timewalking, const std::pair<Colour, Colour>& tod_overrides, const ShimmerColours& shimmer_colours, const int row, const int col);
    static DisplayTile create_unseen_and_explored_display_tile(const TilePtr& tile, const bool timewalking, const std::pair<Colour, Colour>& tod_overrides, const ShimmerColours& shimmer_colours, const int row, const int col);
