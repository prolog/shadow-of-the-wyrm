...
DisplayItemTypePtr DisplayItemTypeFactory::create(const ItemType item_type)
{
  ...
  switch(item_type)
  {
    case ITEM_TYPE_NULL:
    case ITEM_TYPE_MISC:
      display_item_type = std::make_shared<MiscDisplayItemType>();
      break;
    case ITEM_TYPE_WEAPON:
      display_item_type = std::make_shared<WeaponDisplayItemType>();
      break;
    case ITEM_TYPE_ARMOUR:
      display_item_type = std::make_shared<ArmourDisplayItemType>();
      break;
    case ITEM_TYPE_POTION:
      display_item_type = std::make_shared<PotionDisplayItemType>();
      break;
    case ITEM_TYPE_SPELLBOOK:
      display_item_type = std::make_shared<BookDisplayItemType>();
      break;
    case ITEM_TYPE_SCROLL:
      display_item_type = std::make_shared<ScrollDisplayItemType>();
      break;
    case ITEM_TYPE_WAND:
      display_item_type = std::make_shared<WandDisplayItemType>();
      break;
    case ITEM_TYPE_STAFF:
      display_item_type = std::make_shared<StaffDisplayItemType>();
      break;
    case ITEM_TYPE_RING:
      display_item_type = std::make_shared<RingDisplayItemType>();
      break;
    case ITEM_TYPE_AMULET:
      display_item_type = std::make_shared<AmuletDisplayItemType>();
      break;
    case ITEM_TYPE_FOOD:
      display_item_type = std::make_shared<FoodDisplayItemType>();
      break;
    case ITEM_TYPE_AMMUNITION:
      display_item_type = std::make_shared<AmmunitionDisplayItemType>();
      break;
    case ITEM_TYPE_PLANT:
      display_item_type = std::make_shared<PlantDisplayItemType>();
      break;
    case ITEM_TYPE_BOAT:
      display_item_type = std::make_shared<BoatDisplayItemType>();
      break;
    case ITEM_TYPE_CURRENCY:
      display_item_type = std::make_shared<CurrencyDisplayItemType>();
      break;
    case ITEM_TYPE_TOOL:
      display_item_type = std::make_shared<ToolsDisplayItemType>();
      break;
    case ITEM_TYPE_LAST:
    default:
      display_item_type = std::make_shared<DefaultDisplayItemType>();
      break; 
  }
