...
class SettlementGeneratorUtils
{
  public:
    ...
    static bool generate_building_if_possible(MapPtr map, const BuildingGenerationParameters& bgp, std::vector<Building>& buildings, const int growth_rate, const bool allow_shop);
