...
void KeepRuinsGenerator::populate_keep(MapPtr result_map, const int start_row, const int start_col, const int height, const int width)
{
  TilePtr tile;
...
// Dig the door
void KeepRuinsGenerator::create_entrance(MapPtr result_map, const int start_row, const int start_col, const int height, const int width)
{
  TilePtr tile;
