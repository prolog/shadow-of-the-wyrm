...
const string RoomFeatures::ROOM_FEATURE_ORCHARD = "ROOM_FEATURE_ORCHARD";
const string RoomFeatures::ROOM_FEATURE_VEGETATION = "ROOM_FEATURE_VEGETATION";
const string RoomFeatures::ROOM_FEATURE_LITTLE_LIBRARY = "ROOM_FEATURE_LITTLE_LIBRARY";
const string RoomFeatures::ROOM_FEATURE_BEEHIVE = "ROOM_FEATURE_BEEHIVE";
