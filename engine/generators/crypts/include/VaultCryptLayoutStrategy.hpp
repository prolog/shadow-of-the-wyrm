...
class VaultCryptLayoutStrategy : public ICryptLayoutStrategy
{
  ...
  protected:
    ...
    virtual void populate_vault_creatures(MapPtr map, const Coordinate& vault_topleft, const Coordinate& vault_bottomright);
    virtual void populate_vault_items(MapPtr map, const Coordinate& vault_topleft, const Coordinate& vault_bottomright);
