...
namespace SL
{
  ...
  protected:
      ...
      virtual void fill(const MapPtr map, const TileType& TileType::TILE_TYPE);
      virtual bool place_staircase(MapPtr current_map, const int row, const int col, const TileType TileType::TILE_TYPE, const TileType tile_subtype, const Direction direction, const bool link_to_map_exit_id, const bool set_as_player_default_location);
