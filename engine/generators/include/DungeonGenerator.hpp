...
class DungeonGenerator : public SOTW::Generator
{
  ...
  protected:
    ...
    virtual bool    generate_orchard(MapPtr map, const int start_row, const int end_row, const int start_col, const int end_col);
    virtual bool    generate_vegetation(MapPtr map, const int start_row, const int end_row, const int start_col, const int end_col);
    virtual bool    generate_little_library(MapPtr map, const int start_row, const int end_row, const int start_col, const int end_col);
    virtual bool    generate_beehive(MapPtr map, const int start_row, const int end_row, const int start_col, const int end_col);
