...
class VaultPopulator
{
  ...
  protected:
    virtual void populate_vault_creatures(MapPtr map, const TileType tile_type, const std::set<Coordinate>& vault_coords, const int danger_level, const Rarity rarity);
    virtual void populate_vault_items(MapPtr map, const std::set<Coordinate>& vault_coords, const int danger_level, const Rarity rarity);
