...
{
  public:
    void populate_treasure_room(MapPtr map, const TileType TileType::TILE_TYPE, const int danger_level, const int start_row, const int end_row_wall, const int start_col, const int end_col_wall);
  ...
  protected:
    ...
    void generate_creatures(MapPtr map, const TileType TileType::TILE_TYPE, const int danger_level, const int start_row, const int end_row_wall, const int start_col, const int end_col_wall);
