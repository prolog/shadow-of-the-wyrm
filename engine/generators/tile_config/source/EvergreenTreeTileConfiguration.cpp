...
{
  tree_species_ids = {TreeSpeciesID::TREE_SPECIES_CYPRESS, TreeSpeciesID::TREE_SPECIES_FIR, TreeSpeciesID::TREE_SPECIES_CEDAR, TreeSpeciesID::TREE_SPECIES_SPRUCE, TreeSpeciesID::TREE_SPECIES_PINE};
