...
class CathedralGenerator : public ChurchGenerator
{
  ...
  protected:
    ...
    virtual void generate_priest_quarters(MapPtr map, const int room_start_col, const int start_row, const int end_row, const int end_col);
    virtual void generate_secondary_back_room(MapPtr map, const int room_start_col, const int start_row, const int end_row, const int end_col);
