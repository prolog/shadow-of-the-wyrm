...
void HelpScreen::initialize()
{
  ...
  vector<string> options_v = {ScreenTitleTextKeys::SCREEN_TITLE_INTRODUCTION_ROGUELIKES, ScreenTitleTextKeys::SCREEN_TITLE_SOTW_HISTORY, ScreenTitleTextKeys::SCREEN_TITLE_STRATEGY_BASICS, ScreenTitleTextKeys::SCREEN_TITLE_CASINO_GAMES, ScreenTitleTextKeys::SCREEN_TITLE_KEYBINDINGS};
  int cur_id = 0;
