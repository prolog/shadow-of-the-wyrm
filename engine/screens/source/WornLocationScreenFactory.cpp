...
WornLocationSelectionScreenPtr WornLocationScreenFactory::create_skin_screen(DisplayPtr display)
{
  ...
  WornLocationSelectionScreenPtr scr = make_unique<WornLocationSelectionScreen>(display, skin_locs, TextKeys::SKIN_PROMPT);
...
WornLocationSelectionScreenPtr WornLocationScreenFactory::create_weaving_screen(DisplayPtr display)
{
  ...
  WornLocationSelectionScreenPtr scr = make_unique<WornLocationSelectionScreen>(display, weave_locs, TextKeys::WEAVE_PROMPT);
