...
Resistances ResistancesCalculator::calculate_resistances(CreaturePtr creature, RacePtr race, Class* cur_class)
{
...
Resistances ResistancesCalculator::calculate_non_equipment_resistances(CreaturePtr creature, RacePtr race, Class* cur_class)
{
  Resistances res;
