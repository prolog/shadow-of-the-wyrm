...
class PhysicalDamageCalculator : public DamageCalculator
{
  public:
    ...
    virtual int calculate(CreaturePtr defending_creature, const bool attacker_hidden, const bool slays_creatures_race, const Damage& damage, const int base_damage, const float soak_multiplier) override;
