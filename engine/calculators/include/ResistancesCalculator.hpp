...
class ResistancesCalculator
{
  public:
    ...
    Resistances calculate_resistances(CreaturePtr creature, RacePtr race, Class* char_class);
    Resistances calculate_non_equipment_resistances(CreaturePtr creature, RacePtr race, Class* cur_class);
