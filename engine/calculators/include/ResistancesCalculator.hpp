...
class ResistancesCalculator
{
  public:
    ...
    Resistances calculate_resistances(CreaturePtr creature, Race* race, ClassPtr char_class);
    Resistances calculate_non_equipment_resistances(CreaturePtr creature, Race* race, ClassPtr cur_class);
